	...
	<section id="content">
		...
		<main>
			<div class="head-title">
				<div class="left">
					<a href="admin.php"style="font-size: 50px;">Dashboard DOG</a>
					<ul class="breadcrumb">
						<li>
						...
						<li>
							<a class="active" href="admin.php" style="text-decoration: none">Dashboard DOG</a>
						</li>
					</ul>
				</div>
			...
			<div class="table-data">
				...
				<?php } ?>
					<div class="head">
					<span class="ha">เพิ่มข้อมูล สุนัข</span><h3></h3>
						
						<div class="col-md-6 d-flex justify-content-end">

							<button type="button" class="bttn" style="color: #7AB730;" onclick="document.getElementById('id01').style.display='block'"><center><b>ADD</b></center></button>
					...
					<table>
						...
						<?php 
							...
							$stmt = $conn->query("SELECT * FROM userss");
							...
							<td>
								...
								<a href="submitt.php?id=<?= $user['id']; ?>" class="button button1">รับเลี้ยงแล้ว</a>



								<a href="edit.php?id=<?= $user['id']; ?>" class="button button2">แก้ไข</a>
