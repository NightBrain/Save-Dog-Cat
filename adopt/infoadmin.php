     ...
     <nav class="navbar navbar-expand-lg bggen navbar-light shadow-sm py-3 py-lg-0 px-3 px-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="admin.php" class="nav-item nav-link">ADD Animal</a>

                <a href="user_adopt.php" class="nav-item nav-link">User Adopt</a>

                <a href="urole.php" class="nav-item nav-link">urole</a>

                <a href="infoadmin.php" class="nav-item nav-link active"><i class="fa-solid fa-gear"></i></a>
